...
[![OpenSSF Scorecard](https://api.securityscorecards.dev/projects/github.com/felddy/foundryvtt-docker/badge)](https://api.securityscorecards.dev/projects/github.com/felddy/foundryvtt-docker)
...
|`felddy/foundryvtt:10.290.0`| An exact image version. |
|`felddy/foundryvtt:10.290`| The most recent image matching the major and minor version numbers. |
...
| `FOUNDRY_VERSION` | Version of Foundry Virtual Tabletop to install. | `10.290` |
...
```console
docker build \
  --build-arg VERSION=10.290.0 \
  --tag felddy/foundryvtt:10.290.0 \
